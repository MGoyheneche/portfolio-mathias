	...
	<body>
		...
		<header>
			<div class="center">
				<div class="top">
					<div class="logotype">
						<a href="#"><img src="<?php bloginfo( 'template_directory' ); ?>/images/mathias-goyheneche-logo.png" alt="Mathias Goyheneche | Designer & développeur"></a>
					</div>
					<nav class="primary-naviguation">
						<ul>
